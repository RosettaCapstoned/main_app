...
import { APIConfig, Call, Chat, ChatGroup, DevicePermissions, Media, Peer, PeerConnection, Room, User } from './Definitions';
 ...
 * @private
 */
export declare function userIsSpeaking(state: State): boolean;
